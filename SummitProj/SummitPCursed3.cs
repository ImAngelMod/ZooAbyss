...
namespace ZooAbis.SummitProj
{
...

    {
        ...
        public override void AI()
        {
            ...
            int dust2 = Dust.NewDust(Projectile.Center, 1, 1, DustID.CursedTorch, 0f, 0f, 0, default, 1f);
            ...
            if (Main.myPlayer == Projectile.owner)
            {
                ...
                if (ProjDelay <= 1)
                {
                    Projectile.NewProjectile(Projectile.GetSource_FromThis(null), Projectile.Center, Projectile.velocity * +1, ModContent.ProjectileType<SummitPFerra4>(), ProjDamage, 1f, Main.myPlayer, -1, -1);
                    ProjDelay = 5;
                }
            }
        }
