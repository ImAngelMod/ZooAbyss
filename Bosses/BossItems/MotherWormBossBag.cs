...
using ZooAbyss.Items.BossDrops;

namespace ZooAbyss.Bosses.BossItems
{
    // Basic code for a boss treasure bag
    public class MotherWormBossBag : ModItem
    {
        ...
        {
            DisplayName.SetDefault("MotherWurmBag");
        ...
        {
            itemLoot.Add(ItemDropRule.Common(ModContent.ItemType<WurmHook>()));
