...
{
    public class TrueExUtterFlyP : ModProjectile

    {
        ...
        {
            int dust = Dust.NewDust(Projectile.Center, 1, 1, DustID.UndergroundHallowedEnemies, 0f, 0f, 0, default, 1f);
            Main.dust[dust].noGravity = true;
            Main.dust[dust].velocity *= 0.3f;
            Main.dust[dust].scale = Main.rand.Next(50, 135) * 0.012f;

            int dust2 = Dust.NewDust(Projectile.Center, 1, 1, DustID.Tin, 0f, 0f, 0, default, 1f);
            ...
            if (Main.myPlayer == Projectile.owner)
            {
                ...
                if (ProjDelay <= 5)
                {
                    Projectile.NewProjectile(Projectile.GetSource_FromThis(null), Projectile.Center, Projectile.velocity * +3, ProjectileID.LightBeam, ProjDamage, 1f, Main.myPlayer, -1, -1);
                    ProjDelay = 20;
